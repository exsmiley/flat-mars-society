                ...
                try {
                	...
                	if (gc.planet().equals(Planet.Earth)) {
	                    ...
	                    */
                		...
                		if(unit.unitType().equals(UnitType.Rocket) && unit.location().mapLocation().getPlanet().equals(Planet.Mars)) {
                			
                		}else if (unit.unitType().equals(UnitType.Worker) && unit.location().mapLocation().getPlanet().equals(Planet.Mars)) {
                		...
                		}else if (unit.unitType().equals(UnitType.Ranger) && unit.location().mapLocation().getPlanet().equals(Planet.Mars)) {
